    ...
    <>
      ...
      <section className="w-full py-20 bg-neutral-50 border-b border-neutral-200">
        <div className="max-w-screen-lg mx-auto flex flex-col items-center">
          <h1 className="text-6xl md:text-7xl text-center font-serif font-bold text-gray-900 mb-3">
            Scarlett Rivera Hair
          </h1>
          <span className="block w-32 h-2 rounded-full bg-mustard mb-4"></span>
          <p className="text-2xl font-semibold text-mustard text-center tracking-wide font-serif">
            Hair Stylist / Bridal Artist / Hair Extensionist
          </p>
          <Link to="/contact" className="mt-8 px-8 py-3 bg-mustard text-black rounded-full font-bold shadow hover:bg-yellow-300 transition font-serif">
